...
strain. The pandemic strain labels are colored red for clarity. The heatmaps
...
the mutations per 100 nucleotide positions. This file will be automatically
generated by the pipeline, if it goes missing, or the reference fasta files are
updated.
